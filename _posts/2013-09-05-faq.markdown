...
The ITA API is constantly evolving and we will continually make updates. If you have an application that's no longer working, visit the [Change Log](devportal/change-log.html) page to see if any updates are affecting it.
